...
export class Configuration {
    ...
    public static sessionOptions: SessionOptions = {
        ...
        name: 'rememberMe', // The name of the cookie generated by the server, e.g. 'myCookie'
        ...
        secret: 'secretSession', // Encrypt session id using this modifier, e.g. 'Secret'
    };
